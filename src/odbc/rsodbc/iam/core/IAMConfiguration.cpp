...
rs_string IAMConfiguration::GetIssuerUrl() const
{
    return GetSetting(KEY_IDC_ISSUER_URL);
}

////////////////////////////////////////////////////////////////////////////////////////////////////
void IAMConfiguration::SetIssuerUrl(const rs_string& in_issuerUrl)
{
    SetSetting(KEY_IDC_ISSUER_URL, in_issuerUrl);
}
 
////////////////////////////////////////////////////////////////////////////////////////////////////
rs_string IAMConfiguration::GetIdcRegion() const
{
    return GetSetting(KEY_IDC_REGION);
}
 
////////////////////////////////////////////////////////////////////////////////////////////////////
void IAMConfiguration::SetIdcRegion(const rs_string& in_idcRegion)
{
    SetSetting(KEY_IDC_REGION, in_idcRegion);
}

////////////////////////////////////////////////////////////////////////////////////////////////////
rs_string IAMConfiguration::GetIdcClientDisplayName() const
{
    return GetSetting(KEY_IDC_CLIENT_DISPLAY_NAME);
}

////////////////////////////////////////////////////////////////////////////////////////////////////
void IAMConfiguration::SetIdcClientDisplayName(const rs_string& in_idcClientDisplayName)
{
    SetSetting(KEY_IDC_CLIENT_DISPLAY_NAME, in_idcClientDisplayName);
}

////////////////////////////////////////////////////////////////////////////////////////////////////
rs_string IAMConfiguration::GetHost() const
{
    return m_host;
}

////////////////////////////////////////////////////////////////////////////////////////////////////
void IAMConfiguration::SetHost(const rs_string& in_host)
{
    m_host = in_host;
}

////////////////////////////////////////////////////////////////////////////////////////////////////
rs_string IAMConfiguration::GetClusterId() const
{
    return m_clusterId;
}

////////////////////////////////////////////////////////////////////////////////////////////////////
void IAMConfiguration::SetClusterId(const rs_string& in_clusterId)
{
    m_clusterId = in_clusterId;
}

////////////////////////////////////////////////////////////////////////////////////////////////////
rs_string IAMConfiguration::GetWorkgroup() const
{
    return m_workgroup;
}

////////////////////////////////////////////////////////////////////////////////////////////////////
void IAMConfiguration::SetWorkgroup(const rs_string& in_workgroup)
{
    m_workgroup = in_workgroup;
}

////////////////////////////////////////////////////////////////////////////////////////////////////
bool IAMConfiguration::GetIsServerless() const
{
    return m_isServerless;
}

////////////////////////////////////////////////////////////////////////////////////////////////////
void IAMConfiguration::SetIsServerless(bool in_isServerless)
{
    m_isServerless = in_isServerless;
}

////////////////////////////////////////////////////////////////////////////////////////////////////
bool IAMConfiguration::GetAllowPrompt() const
{
    return m_allowPrompt;
}

////////////////////////////////////////////////////////////////////////////////////////////////////
void IAMConfiguration::SetAllowPrompt(bool in_allowPrompt)
{
    m_allowPrompt = in_allowPrompt;
}
